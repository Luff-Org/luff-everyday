...
export default function LandingPage() {
  ...
  const cards = [
    {
      ...
      icon: <Keyboard className="w-12 h-12 mb-4 group-hover:scale-110 transition-transform text-primary" />,
      href: "/typing",
      active: true,
    },
    {
      ...
      icon: <Target className="w-12 h-12 mb-4 text-sub-text group-hover:scale-110 transition-transform" />,
      href: "#",
      active: false,
    },
    {
      ...
      icon: <Zap className="w-12 h-12 mb-4 text-sub-text group-hover:scale-110 transition-transform" />,
      href: "#",
      active: false,
    },
    {
      ...
      icon: <Lock className="w-12 h-12 mb-4 text-sub-text group-hover:scale-110 transition-transform" />,
      href: "#",
      active: false,
    },
  ];
  ...
  return (
    <main className="w-full flex flex-col items-center flex-1 h-[200vh]" ref={containerRef}>
      <div className="w-full max-w-5xl px-8 flex flex-col items-center">
        ...
        >
          ...
          >
            <h1 className="text-7xl md:text-8xl font-extrabold text-foreground tracking-tight mb-8 drop-shadow-2xl">
              Elevate your <span className="text-primary z-10 relative">everyday</span> focus.
            </h1>
            <p className="text-2xl text-sub-text max-w-2xl mx-auto mb-16 leading-relaxed font-medium">
              A minimalist suite of tools designed to help you organize thoughts, practice skills, and reclaim your time.
            </p>
            <motion.div
               animate={{ y: [0, 10, 0] }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl z-10 pb-40">
          {cards.map((card, idx) => (
            ...
            >
              {card.active ? (
                <Link href={card.href} className="absolute inset-0 z-20 rounded-3xl" />
              ) : (
              ...
              >
                {card.icon}
                <h3 className={`text-3xl font-bold mb-4 ${card.active ? "text-foreground" : "text-foreground/50"}`}>
                  {card.title}
                </h3>
